...
import '../rendering/render_gap.dart';

/// A widget that takes a fixed amount of space in the direction of its parent.
///
/// The [Gap] widget works in the following contexts:
/// - It automatically detects direction when placed inside a [Row], [Column], [Flex], [Wrap], or [OverflowBar].
/// - It detects scroll direction when placed inside a [Scrollable] widget.
/// - When used in any other widget with children, it defaults to vertical spacing (height).
///
/// See also:
///
...
class Gap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Axis fallbackDirection = axisDirection == null
        ? Axis
              .vertical // Default to vertical for all widgets with children
...
/// [Flex], [Wrap], or [OverflowBar] widget.
///
/// A [MaxGap] widget must be a descendant of a [Row], [Column], [Flex],
/// [Wrap], or [OverflowBar], and the path from the [MaxGap] widget to its enclosing [Row], [Column],
/// [Flex], [Wrap], or [OverflowBar] must contain only [StatelessWidget]s or [StatefulWidget]s (not other
...
class MaxGap extends StatelessWidget {
  ...
  /// space in a [Row], [Column], [Flex], [Wrap], or [OverflowBar] widget.
  ///
  /// The [mainAxisExtent] must not be null and must be positive.
  /// The [crossAxisExtent] must be either null or positive.
  const MaxGap(
  ...
  /// Creates a widget that takes, at most, the specified [mainAxisExtent] of
  /// space in a [Row], [Column], [Flex], [Wrap], or [OverflowBar] widget and expands in the cross axis
  /// direction.
  ///
  /// The [mainAxisExtent] must not be null and must be positive.
  /// The [crossAxisExtent] must be either null or positive.
