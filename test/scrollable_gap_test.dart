    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: Center(
          child: SizedBox(
            width: 200,
            child: ListView(children: const <Widget>[Gap(100)]),
          ),
        ),
      ),
    );
      ...
      Directionality(
        ...
        child: Center(
          child: SizedBox(
            width: 200,
            child: ListView(
              children: const <Widget>[Gap(100, crossAxisExtent: 20)],
            ),
          ),
        ),
      ),
        ...
        child: Center(
          child: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Row(children: <Widget>[Gap(100)]),
            ),
          ),
        ),
      ),
        ...
        child: Center(
          child: SizedBox(
            ...
            child: Row(
              children: [
                Container(width: 100),
                const SingleChildScrollView(child: Gap(100)),
                Container(width: 100),
              ],
            ),
          ),
